...
public ResponseEntity<String> handleValidationException(MethodArgumentNotValidException ex) {
	...
	return new ResponseEntity<String>("Validation error(s): " + errors.toString(), HttpStatus.BAD_REQUEST);
}

@ExceptionHandler(exception = Exception.class)
public ResponseEntity<ExceptionResponse>validException(Exception ex)
{
 return null;
}
